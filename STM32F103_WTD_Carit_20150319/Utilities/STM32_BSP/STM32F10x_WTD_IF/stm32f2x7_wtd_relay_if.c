...
#include "stm32f2x7_wtd_74hc595.h"
#include "stm32f2x7_wtd_eeprom.h"
#include "stm32f2x7_wtd_74hc165.h"
/* Add WTD interfaces includes */
#include "stm32f2x7_wtd_relay_if.h"

#if (WTD_RELAY_EN)

#define E2P_TIMEOUTH_ADDR			(0x16)
#define E2P_TIMEOUTL_ADDR			(0x19)
#define E2P_SAFYENABLE_ADDR			(0x1C)
#define E2P_SAFYPOSH_ADDR			(0x20)
#define E2P_SAFYPOSL_ADDR			(0x23)
...
void if_relay_init(void)
{
	...
	m_stLed74595.RCL_GPIO_Pin = GPIO_Pin_14;
	m_stLed74595.SCL_GPIO_Pin = GPIO_Pin_15;
	m_stLed74595.SDA_GPIO_Pin = GPIO_Pin_3;

	m_stLed74595.RCL_GPIOx = GPIOB;
	m_stLed74595.SCL_GPIOx = GPIOB;
	m_stLed74595.SDA_GPIOx = GPIOD;

	m_stRly74595.RCL_GPIO_Pin = GPIO_Pin_4;
	m_stRly74595.SCL_GPIO_Pin = GPIO_Pin_6;
	m_stRly74595.SDA_GPIO_Pin = GPIO_Pin_3;

	m_stRly74595.RCL_GPIOx = GPIOE;
	m_stRly74595.SCL_GPIOx = GPIOE;
	m_stRly74595.SDA_GPIOx = GPIOE;
	...
	Driver_74hc595(&m_stLed74595,u16_Relaypos);
	Driver_74hc595(&m_stRly74595,u16_Relaypos);
...
void if_relay_Proc(void)
{
	...
	if(u16_SafyEnable == 1)
	{
		...
		{//超时，需要强制继电器模块进入安全模式
			Driver_74hc595(&m_stLed74595,u16_RelaySafypos);
			Driver_74hc595(&m_stRly74595,u16_Relaypos);
...
#if WTD678C
	u16_Inputpos = Driver_74hc165(&m_74165);
